...
<div id="headder">
  ...
  <div id="club" class="center">
  <h2>Club details &nbsp; &nbsp; &nbsp;<a href="clubdata.php" class="blink"><span>Click here to see club data</span></a></h2>
    <form action="insertclub.php" method="post">
      <input type="text" name="club_id" id="club_id" placeholder="enter the club id">
      <input type="text" name="name" id="name" placeholder="enter the club name">
      <input type="text" name="owner" id="owner" placeholder="enter the owner name">
      <input type="text" name="location" id="location" placeholder="enter the location">
      <input type="text" name="estd_date" id="estd_date" placeholder="enter the date">
