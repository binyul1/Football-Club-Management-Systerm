...
<div id="headder">
  ...
  <div id="league" class="center">
    <h2>League details&nbsp; &nbsp; &nbsp;<a href="leaguedata.php" class="blink"><span>Click here to see league data</span></a></h2>
    <form action="insertleague.php" method="post">
      ...
      <input type="text" name="start_date" id="start_date" placeholder="enter the start date">
      <input type="text" name="end_date" id="end_date" placeholder="enter the end date">
      <input type="text" name="no_of_teams" id="no_of_teams" placeholder="enter the number of teams"><br>
