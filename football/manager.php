...
<div id="headder">
  ...
  <h2>Manager details&nbsp; &nbsp; &nbsp;<a href="managerdata.php" class="blink"><span>Click here to see manager data</span></a></h2>
    <form action="insertmanager.php" method="post">
      <input type="text" name="manager_id" id="manager_id" placeholder="enter the manager id"><br>
      <input type="text" name="name" id="name" placeholder="enter the manager name"><br>
      <input type="text" name="salary" id="salary" placeholder="enter the salary"><br>
      <input type="text" name="club_id" id="club_id" placeholder="enter the club_id"><br>
