...
<div id="headder">
  ...
  <div id="match" class="center">
  <h2>Match details&nbsp; &nbsp; &nbsp;<a href="matchdata.php" class="blink"><span>Click here to see match data</span></a></h2>
    <form action="insertmatch.php" method="post">
      <input type="text" name="match_id" id="match_id" placeholder="enter the match id">
      <input type="text" name="start_time" id="start_time" placeholder="enter the start time">
      <input type="text" name="end_time" id="end_time" placeholder="enter the end time">
      <input type="text" name="match_date" id="match_date" placeholder="enter the match date">
      <input type="text" name="league_id" id="league_id" placeholder="enter the league id">
      <input type="text" name="stadium_id" id="stadium_id" placeholder="enter the stadium id"><br>
