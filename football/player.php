...
<div id="headder">
  ...
  <h2>Player details&nbsp; &nbsp; &nbsp;<a href="playerdata.php" class="blink"><span>Click here to see player data</span></a></h2>
    <form action="insertplayer.php" method="post">
      <input type="text" name="player_id" id="player_id" placeholder="enter the player id">
      ...
      <input type="text" name="salary" id="salary" placeholder="enter the salary">
      <input type="text" name="position" id="position" placeholder="enter the position">
      <input type="text" name="club_id" id="club_id" placeholder="enter the club id">
      <input type="text" name="manager_id" id="manager_id" placeholder="enter the manager id">
      <input type="text" name="match_id" id="match_id" placeholder="enter the match id">
      <input type="text" name="league_id" id="league_id" placeholder="enter the league id"><br>
