...
<div id="headder">
  ...
  <div id="stadium" class="center">
  <h2>Stadium details&nbsp; &nbsp; &nbsp;<a href="stadiumdata.php" class="blink"><span>Click here to see stadium data</span></a></h2>
    <form action="insertstadium.php" method="post">
      <input type="text" name="stadium_id" id="stadium_id" placeholder="enter the stadium id">
      <input type="text" name="name" id="name" placeholder="enter the stadium name">
